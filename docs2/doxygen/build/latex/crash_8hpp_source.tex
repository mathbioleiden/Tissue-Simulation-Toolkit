...
\hypertarget{crash_8hpp_source}{}\label{crash_8hpp_source}\index{/Users/koenkeijzer/Documents/CPM/Tissue-\/Simulation-\/Toolkit/src/util/crash.hpp@{/Users/koenkeijzer/Documents/CPM/Tissue-\/Simulation-\/Toolkit/src/util/crash.hpp}}
...
\DoxyCodeLine{00023\ \textcolor{keywordtype}{void}\ StartSIGINTHandling();}
\DoxyCodeLine{00024\ \textcolor{keywordtype}{void}\ HandleSIGINT(\textcolor{keywordtype}{int}\ dummy);}
\DoxyCodeLine{00025\ \textcolor{keywordtype}{void}\ StartSIGSEGVHandling();}
\DoxyCodeLine{00026\ \textcolor{keywordtype}{void}\ HandleSIGSEGV(\textcolor{keywordtype}{int}\ dummy);}
\DoxyCodeLine{00027\ \textcolor{keywordtype}{void}\ NiceMessage();}
\DoxyCodeLine{00028\ \textcolor{keywordtype}{void}\ MemoryWarning(\textcolor{keywordtype}{void});}
\DoxyCodeLine{00029\ \textcolor{keywordtype}{void}\ Crash(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *message);}
