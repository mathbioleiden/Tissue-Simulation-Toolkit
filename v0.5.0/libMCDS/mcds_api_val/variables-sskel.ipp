...
namespace variables
{
  ...
  : ::xml_schema::string_sskel (tiein, 0),
    amount_type_impl_ (0)
  {
    this->_enumeration_facet (_xsde_amount_type_sskel_enums_, 12UL);
  }
  ...
  : ::xml_schema::string_sskel (tiein, 0),
    system_impl_ (0)
  {
    this->_enumeration_facet (_xsde_system_sskel_enums_, 4UL);
  }
  ...
  : ::xml_schema::string_sskel (tiein, 0),
    conditions_impl_ (0)
  {
    this->_enumeration_facet (_xsde_conditions_sskel_enums_, 3UL);
  }
