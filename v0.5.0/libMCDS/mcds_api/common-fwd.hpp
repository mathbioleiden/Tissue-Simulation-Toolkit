...
namespace common
{
  class custom;
  class double_list;
  class unsigned_int_list;
  class two_doubles;
  class units_double_list;
  class delimited_list;
  class units_delimited_list;
  class units_decimal;
  class units_decimal_nonnegative;
  class units_unsignedShort;
  class units_boolean;
  class fraction;
  class units_fraction;
  class units_string;
  class data_storage_formats;
  class threshold_type;
  class transition_threshold;
}
