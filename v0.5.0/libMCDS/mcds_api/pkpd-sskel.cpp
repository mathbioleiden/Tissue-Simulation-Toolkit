...
namespace pkpd
{
  ...
  _serialize_content ()
  {
    ...
    if (this->inactivation_rate_present ())
    {
      ...
      if (t == 0 && this->inactivation_rate_serializer_ != 0)
        ...
        s = static_cast< ::common::units_decimal_sskel* > (
          this->inactivation_rate_serializer_map_->find (t));
    ...
    if (this->half_life_present ())
    {
      ...
      if (t == 0 && this->half_life_serializer_ != 0)
        ...
        s = static_cast< ::common::units_decimal_sskel* > (
          this->half_life_serializer_map_->find (t));
      ...
      case dose_tag:
      {
        ...
        //
        {
          ...
          if (t == 0 && this->dose_serializer_ != 0)
            ...
            s = static_cast< ::pkpd::dose_sskel* > (
              this->dose_serializer_map_->find (t));
          ...
          if (s)
          {
            ...
            {
              dt = s->_dynamic_type ();
              if (strcmp (dt, ::pkpd::dose_sskel::_static_type ()) == 0)
                dt = 0;
            }
      ...
      case pharmacokinetics_tag:
      {
        ...
        //
        {
          ...
          if (t == 0 && this->pharmacokinetics_serializer_ != 0)
            ...
            s = static_cast< ::pkpd::pharmacokinetics_sskel* > (
              this->pharmacokinetics_serializer_map_->find (t));
          ...
          if (s)
          {
            ...
            {
              dt = s->_dynamic_type ();
              if (strcmp (dt, ::pkpd::pharmacokinetics_sskel::_static_type ()) == 0)
                dt = 0;
            }
  ...
  _serialize_content ()
  {
    ...
    while (this->drug_next ())
    {
      ...
      if (t == 0 && this->drug_serializer_ != 0)
        ...
        s = static_cast< ::pkpd::drug_dose_sskel* > (
          this->drug_serializer_map_->find (t));
      ...
      if (s)
      {
        ...
        {
          dt = s->_dynamic_type ();
          if (strcmp (dt, ::pkpd::drug_dose_sskel::_static_type ()) == 0)
            dt = 0;
        }
  ...
  _serialize_content ()
  {
    ...
    if (this->maximum_birth_inhibition_present ())
    {
      ...
      if (t == 0 && this->maximum_birth_inhibition_serializer_ != 0)
        ...
        s = static_cast< ::common::units_decimal_sskel* > (
          this->maximum_birth_inhibition_serializer_map_->find (t));
    ...
    if (this->maximum_birth_inhibition_time_present ())
    {
      ...
      if (t == 0 && this->maximum_birth_inhibition_time_serializer_ != 0)
        ...
        s = static_cast< ::common::units_decimal_sskel* > (
          this->maximum_birth_inhibition_time_serializer_map_->find (t));
    ...
    if (this->birth_inhibition_recovery_rate_present ())
    {
      ...
      if (t == 0 && this->birth_inhibition_recovery_rate_serializer_ != 0)
        ...
        s = static_cast< ::common::units_decimal_sskel* > (
          this->birth_inhibition_recovery_rate_serializer_map_->find (t));
    ...
    if (this->maximum_death_rate_present ())
    {
      ...
      if (t == 0 && this->maximum_death_rate_serializer_ != 0)
        ...
        s = static_cast< ::common::units_decimal_sskel* > (
          this->maximum_death_rate_serializer_map_->find (t));
    ...
    if (this->maximum_death_time_present ())
    {
      ...
      if (t == 0 && this->maximum_death_time_serializer_ != 0)
        ...
        s = static_cast< ::common::units_decimal_sskel* > (
          this->maximum_death_time_serializer_map_->find (t));
    ...
    if (this->death_recovery_rate_present ())
    {
      ...
      if (t == 0 && this->death_recovery_rate_serializer_ != 0)
        ...
        s = static_cast< ::common::units_decimal_sskel* > (
          this->death_recovery_rate_serializer_map_->find (t));
    ...
    while (this->response_observation_next ())
    {
      ...
      if (t == 0 && this->response_observation_serializer_ != 0)
        ...
        s = static_cast< ::pkpd::response_observation_sskel* > (
          this->response_observation_serializer_map_->find (t));
      ...
      if (s)
      {
        ...
        {
          dt = s->_dynamic_type ();
          if (strcmp (dt, ::pkpd::response_observation_sskel::_static_type ()) == 0)
            dt = 0;
        }
  ...
  _serialize_content ()
  {
    ...
    if (this->time_present ())
    {
      ...
      if (t == 0 && this->time_serializer_ != 0)
        ...
        s = static_cast< ::common::units_decimal_sskel* > (
          this->time_serializer_map_->find (t));
    ...
    if (this->net_death_rate_present ())
    {
      ...
      if (t == 0 && this->net_death_rate_serializer_ != 0)
        ...
        s = static_cast< ::common::units_decimal_sskel* > (
          this->net_death_rate_serializer_map_->find (t));
    ...
    if (this->apoptotic_duration_present ())
    {
      ...
      if (t == 0 && this->apoptotic_duration_serializer_ != 0)
        ...
        s = static_cast< ::common::units_decimal_sskel* > (
          this->apoptotic_duration_serializer_map_->find (t));
    ...
    if (this->percent_cell_viability_present ())
    {
      ...
      if (t == 0 && this->percent_cell_viability_serializer_ != 0)
        ...
        s = static_cast< ::common::units_decimal_sskel* > (
          this->percent_cell_viability_serializer_map_->find (t));
  ...
  _serialize_content ()
  {
    ...
    //
    while (this->therapy_measurement_set_next ())
    {
      ctx.type_id (0);
      ...
      if (t == 0 && this->therapy_measurement_set_serializer_ != 0)
        ...
        s = static_cast< ::pkpd::therapy_measurement_set_sskel* > (
          this->therapy_measurement_set_serializer_map_->find (t));
      ...
      if (s)
      {
        ...
        {
          dt = s->_dynamic_type ();
          if (strcmp (dt, ::pkpd::therapy_measurement_set_sskel::_static_type ()) == 0)
            dt = 0;
        }
  ...
  _serialize_content ()
  {
    ...
    //
    {
      ...
      if (t == 0 && this->therapy_serializer_ != 0)
        ...
        s = static_cast< ::pkpd::therapy_sskel* > (
          this->therapy_serializer_map_->find (t));
      ...
      if (s)
      {
        ...
        {
          dt = s->_dynamic_type ();
          if (strcmp (dt, ::pkpd::therapy_sskel::_static_type ()) == 0)
            dt = 0;
        }
    ...
    //
    {
      ...
      if (t == 0 && this->response_serializer_ != 0)
        ...
        s = static_cast< ::pkpd::response_sskel* > (
          this->response_serializer_map_->find (t));
      ...
      if (s)
      {
        ...
        {
          dt = s->_dynamic_type ();
          if (strcmp (dt, ::pkpd::response_sskel::_static_type ()) == 0)
            dt = 0;
        }
  ...
  _serialize_content ()
  {
    ...
    while (this->drug_next ())
    {
      ...
      if (t == 0 && this->drug_serializer_ != 0)
        ...
        s = static_cast< ::pkpd::drug_pk_sskel* > (
          this->drug_serializer_map_->find (t));
      ...
      if (s)
      {
        ...
        {
          dt = s->_dynamic_type ();
          if (strcmp (dt, ::pkpd::drug_pk_sskel::_static_type ()) == 0)
            dt = 0;
        }
    ...
    if (this->pharmacodynamics_present ())
    {
      ...
      if (t == 0 && this->pharmacodynamics_serializer_ != 0)
        ...
        s = static_cast< ::pkpd::pharmacodynamics_sskel* > (
          this->pharmacodynamics_serializer_map_->find (t));
      ...
      if (s)
      {
        ...
        {
          dt = s->_dynamic_type ();
          if (strcmp (dt, ::pkpd::pharmacodynamics_sskel::_static_type ()) == 0)
            dt = 0;
        }
