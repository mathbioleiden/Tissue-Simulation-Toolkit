...
namespace cell
{
  // Element validation and serialization for population_definition_sskel.
  //
  void population_definition_sskel::
  _serialize_content ()
  {
    ...
    if (this->phenotype_dataset_present ())
    {
      ...
      {
        ::xml_schema::serializer_base* b = this->phenotype_dataset_serializer_map_->find (t);

        if (b != 0)
        {
          dt = b->_dynamic_type ();
          const char* st = ::phenotype_dataset::phenotype_dataset_sskel::_static_type ();
          ...
          s = static_cast< ::phenotype_dataset::phenotype_dataset_sskel* > (b);
        }
      }
  ...
  // Element validation and serialization for population_definitions_sskel.
  //
  void population_definitions_sskel::
  _serialize_content ()
  {
    ...
    {
      size_t i = 0;
      for (; this->population_definition_next (); ++i)
      {
        ctx.type_id (0);
        ...
        {
          ::xml_schema::serializer_base* b = this->population_definition_serializer_map_->find (t);

          if (b != 0)
          {
            dt = b->_dynamic_type ();
            const char* st = ::cell::population_definition_sskel::_static_type ();
            ...
            s = static_cast< ::cell::population_definition_sskel* > (b);
          }
        }
  ...
  // Element validation and serialization for cell_sskel.
  //
  void cell_sskel::
  _serialize_content ()
  {
    ...
    if (this->state_present ())
    {
      ...
      {
        ::xml_schema::serializer_base* b = this->state_serializer_map_->find (t);

        if (b != 0)
        {
          dt = b->_dynamic_type ();
          const char* st = ::state::state_sskel::_static_type ();
          ...
          s = static_cast< ::state::state_sskel* > (b);
        }
      }
  ...
  // Element validation and serialization for cell_population_individual_sskel.
  //
  void cell_population_individual_sskel::
  _serialize_content ()
  {
    ...
    while (this->cell_next ())
    {
      ...
      {
        ::xml_schema::serializer_base* b = this->cell_serializer_map_->find (t);

        if (b != 0)
        {
          dt = b->_dynamic_type ();
          const char* st = ::cell::cell_sskel::_static_type ();
          ...
          s = static_cast< ::cell::cell_sskel* > (b);
        }
      }
  ...
  // Element validation and serialization for cell_population_aggregate_sskel.
  //
  void cell_population_aggregate_sskel::
  _serialize_content ()
  {
  ...
  // Element validation and serialization for population_vector_sskel.
  //
  void population_vector_sskel::
  _serialize_content ()
  {
    ...
    while (this->cell_population_next ())
    {
      ...
      {
        ::xml_schema::serializer_base* b = this->cell_population_serializer_map_->find (t);

        if (b != 0)
        {
          dt = b->_dynamic_type ();
          const char* st = ::cell::cell_population_aggregate_sskel::_static_type ();
          ...
          s = static_cast< ::cell::cell_population_aggregate_sskel* > (b);
        }
      }
  ...
  // Element validation and serialization for cell_populations_sskel.
  //
  void cell_populations_sskel::
  _serialize_content ()
  {
    ...
    while (this->population_vector_next ())
    {
      ...
      {
        ::xml_schema::serializer_base* b = this->population_vector_serializer_map_->find (t);

        if (b != 0)
        {
          dt = b->_dynamic_type ();
          const char* st = ::cell::population_vector_sskel::_static_type ();
          ...
          s = static_cast< ::cell::population_vector_sskel* > (b);
        }
      }
    ...
    if (this->cell_population_present ())
    {
      ...
      else if (this->cell_population_serializer_map_ != 0)
      {
        ...
        {
          dt = b->_dynamic_type ();
          const char* st = ::cell::cell_population_individual_sskel::_static_type ();
          ...
          s = static_cast< ::cell::cell_population_individual_sskel* > (b);
        }
      }
  ...
  // Element validation and serialization for cellular_information_sskel.
  //
  void cellular_information_sskel::
  _serialize_content ()
  {
    ...
    if (this->DCLs_present ())
    {
      ...
      {
        ::xml_schema::serializer_base* b = this->DCLs_serializer_map_->find (t);

        if (b != 0)
        {
          dt = b->_dynamic_type ();
          const char* st = ::cell_line::DCLs_sskel::_static_type ();
          ...
          s = static_cast< ::cell_line::DCLs_sskel* > (b);
        }
      }
    ...
    if (this->population_definitions_present ())
    {
      ...
      {
        ::xml_schema::serializer_base* b = this->population_definitions_serializer_map_->find (t);

        if (b != 0)
        {
          dt = b->_dynamic_type ();
          const char* st = ::cell::population_definitions_sskel::_static_type ();
          ...
          s = static_cast< ::cell::population_definitions_sskel* > (b);
        }
      }
    ...
    if (this->cell_populations_present ())
    {
      ...
      {
        ::xml_schema::serializer_base* b = this->cell_populations_serializer_map_->find (t);

        if (b != 0)
        {
          dt = b->_dynamic_type ();
          const char* st = ::cell::cell_populations_sskel::_static_type ();
          ...
          s = static_cast< ::cell::cell_populations_sskel* > (b);
        }
      }
...
namespace cell
{
  // Attribute validation and serialization for population_definition_sskel.
  //
  void population_definition_sskel::
  ...
  // Attribute validation and serialization for cell_sskel.
  //
  void cell_sskel::
  _serialize_attributes ()
  {
  ...
  // Attribute validation and serialization for cell_population_individual_sskel.
  //
  void cell_population_individual_sskel::
  _serialize_attributes ()
  {
  ...
  // Attribute validation and serialization for cell_population_aggregate_sskel.
  //
  void cell_population_aggregate_sskel::
  _serialize_attributes ()
  {
  ...
  // Attribute validation and serialization for population_vector_sskel.
  //
  void population_vector_sskel::
  _serialize_attributes ()
  {
