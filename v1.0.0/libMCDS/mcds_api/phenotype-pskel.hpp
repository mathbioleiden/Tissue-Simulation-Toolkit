...
#ifndef PHENOTYPE_PSKEL_HPP
#define PHENOTYPE_PSKEL_HPP
...
namespace phenotype
{
  class phenotype_elements_pskel;
  class phenotype_pskel;
}
...
namespace phenotype
{
  class phenotype_elements_pskel: public ::cell_cycle::cycles_and_deaths_pskel
  {
    public:
    ...
    protected:
    phenotype_elements_pskel* phenotype_elements_impl_;
    phenotype_elements_pskel (phenotype_elements_pskel*, void*);
    ...
    {
      void (::phenotype::phenotype_elements_pskel::*func) (
        unsigned long&,
        unsigned long&,
        const ::xsde::cxx::ro_string&,
        const ::xsde::cxx::ro_string&,
  ...
  class phenotype_pskel: public ::phenotype::phenotype_elements_pskel
  {
    public:
    // Parser callbacks. Override them in your implementation.
    //
    ...
    protected:
    phenotype_pskel* phenotype_impl_;
    phenotype_pskel (phenotype_pskel*, void*);
