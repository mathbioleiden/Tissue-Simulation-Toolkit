...
void QtGLGraphics::DensityPlot(float * data, int xsize, int ysize, float r, float g, float b) {
  float z = 0;
...
void QtGLGraphics::cpmLinePlot(int * data, int xsize, int ysize, float r, float g, float b) {
  float z = 0;
  float single_rect[] = {-1, 1,z, 1,1,z, -1,-1,z,  
			 -1,-1,z, 1,1,z, 1,-1,z};
  float cols[] = {r,g,b,1, r,g,b,1, r,g,b,1, 
...
void QtGLGraphics::contourPlot(float * data, int xsize, int ysize, float r, float g, float b) {
  float z = 0;
  float single_rect[] = {-1, 1,z, 1,1,z, -1,-1,z,  
			 -1,-1,z, 1,1,z, 1,-1,z};
  float cols[] = {r,g,b,1, r,g,b,1, r,g,b,1, 
