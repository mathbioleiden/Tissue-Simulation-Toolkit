...
TARGET = singlecell_dynamic_polarity
MAINFILE = "models/singlecell_dynamic_polarity.cpp"
...
INCLUDEPATH += $$MUSCLE3_DIR/../muscle3_src/libmuscle/cpp/build/msgpack/msgpack/include
