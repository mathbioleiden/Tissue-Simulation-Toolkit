 ...
 *
 * The TST has been compiled on Windows XP, Windows 7 (minGW), MacOS X and Linux
 * systems (GNU C++). The following libraries are required:
 *
 * Qt (version 4)
 * libpng and libz
 *
 * For Unix, we also have an (obsolete) X11-only version, although compilation
 * is easiest with the qmake tool shipped with Qt (see http://www.trolltech.com)
 *
 * With Qt, simply type:
 *
 * qmake
 ...
 *
 * An automatically generated class documentation is included in
 * html/index.html.
 *
 * A tutorial on CPM programming will soon come out as:
 * Josephine T. Daub and Roeland M. H. Merks.
 * Cell-based computational modeling of vascular morphogenesis using Tissue
 * Simulation Toolkit. In: Vascular Morphogenesis. Domenico Ribatti (Ed.)
 ...
 *
 * - Merks, R. M. H., Perryn, E. D., Shirinifard, A., and Glazier, J. A., 2008.
 * Contact-inhibited chemotaxis in de novo and sprouting blood-vessel growth.
 * PLoS Comput Biol 4(9): e1000163.
 *
 */
