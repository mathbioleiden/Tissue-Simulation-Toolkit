...
public:
  ...
  void InitializeEdgeList(
      void); // Set the initial edgelist which are eligible to change
  ...
  */
  ...
  /*! Implements standard large q-Potts model via Neighbor copies.  Carries out
  ...
  */
  ...
  /*! \brief Initialize the CA plane with n cells using an Eden growth
  algorithm.
