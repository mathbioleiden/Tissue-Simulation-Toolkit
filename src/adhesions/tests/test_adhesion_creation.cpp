...
TEST_CASE("Test adhesion zone basic", "[adhesion_creation]") {
  ...
  SECTION("Radius 1.0") {
    ...
    std::vector<PixelPos> expected = {{1, 3}, {0, 2}, {2, 2}, {1, 1}};
  ...
  SECTION("Radius 1.5") {
    ...
    std::vector<PixelPos> expected = {{1, 3}, {0, 2}, {1, 2}, {2, 2}, {1, 1}};
...
TEST_CASE("Test adhesion zone with more cells", "[adhesion_creation]") {
  ...
  SECTION("Radius 1.0") {
    ...
    std::vector<PixelPos> expected = {{1, 3}, {2, 3}, {3, 3}, {0, 2}, {2, 2},
                                      {3, 2}, {1, 1}, {2, 1}, {3, 1}};
  ...
  SECTION("Radius 1.5") {
    ...
    std::vector<PixelPos> expected = {{1, 3}, {2, 3}, {3, 3}, {0, 2}, {1, 2},
                                      {2, 2}, {3, 2}, {1, 1}, {2, 1}, {3, 1}};
...
TEST_CASE("Test adhesion zone at edge", "[adhesion_creation]") {
  ...
  SECTION("Radius 1.0") {
    ...
    std::vector<PixelPos> expected = {{2, 4}, {2, 3}, {0, 2}, {2, 2}, {3, 2},
                                      {4, 2}, {1, 1}, {2, 1}, {2, 0}};
  ...
  SECTION("Radius 2.0") {
    ...
    std::vector<PixelPos> expected = {
        {1, 4}, {2, 4}, {0, 3}, {1, 3}, {2, 3}, {0, 2}, {1, 2}, {2, 2},
        {3, 2}, {4, 2}, {1, 1}, {2, 1}, {3, 1}, {4, 1}, {2, 0}, {3, 0}};
