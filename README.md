...
We also created a script that checks that any file that you commit using `git commit` is formatted correctly. To activate this script you have to let git know where it is located. You can do this by running:
